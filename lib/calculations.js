...
export const FahrenheitToDegree = (temperatur) => Math.floor((temperatur - 32) * (5/9));

// calculate Miles to Kilometers
export const milesToKilometers = (miles) => (miles * 1.609).toFixed(1);
...
export const imageName = (cloudcover, conditions) => {
    ...
    // if(conditions.includes('loud') && conditions.includes('ain')) {
        // new RegExp( filterstrings.join( "|" ), "i")
