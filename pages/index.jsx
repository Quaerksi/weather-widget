...
export default function Widget(props) {
  ...
  const handleData = location => {
    ...
    // queries are limited
    fetch(`https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${location}?key=${process.env.NEXT_PUBLIC_KEY}&contentType=json`).then(res=>{
      ...
      if(data.address){
        ...
        // To Do: break up in small functions
